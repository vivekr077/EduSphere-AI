    ...
    <div className='mt-10 p-5 max-sm:p-0'>
        ...
        <div className='grid max-sm:grid-cols-1 grid-cols-2 gap-5 mt-6'>
            {quiz?.options.map((option, index)=>(
                ...
                className={`w-full border rounded-full p-3 px-4 text-center text-lg hover:bg-gray-200 cursor-pointer ${selectedOption===option&&'bg-primary text-white hover:bg-primary'}`} >{option}</div>
            ))}
